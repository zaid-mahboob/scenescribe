...
response = model.generate_content(
    [
        "Suppose you are an assistant for a visually impaired, act as an assistant and guide him in indoor environment. Tell in such a manner that it gives a concise surrounding perception and give him overview of hi surroundings. Keep it small and concise",
        img,
    ],
    stream=True,
)
